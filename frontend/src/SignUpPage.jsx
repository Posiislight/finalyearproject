...
const SignUpPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Handle specific field errors from Django if they exist
                ...
                <div className="flex w-full max-w-[480px] flex-col gap-8">
                    ...
                    <div className="w-full">
                        <div className="flex h-12 w-full items-center justify-center rounded-xl bg-slate-200 dark:bg-surface-dark p-1">
                            <Link to="/login" className="flex h-full flex-1 cursor-pointer items-center justify-center rounded-lg px-2 text-sm font-medium transition-all text-slate-500 dark:text-slate-400 hover:text-primary">
                    ...
                    {success && (
                        <div className="rounded-lg bg-green-50 p-4 text-sm text-green-600 dark:bg-green-900/10 dark:text-green-400 border border-green-100 dark:border-green-900/20">
                            {success}
                        </div>
                    )}
                    ...
                    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-start gap-2">
                            <div className="flex h-5 items-center">
                                <input required className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary dark:border-slate-600 dark:bg-surface-dark dark:ring-offset-slate-800" id="terms" type="checkbox" />
                            </div>
